...
namespace CustomerProject.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Date,Description,Total,CustomerId")] Orders order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Date,Description,Total,CustomerId")] Orders order)
        {
            if (ModelState.IsValid)
            {
